package com.dataservicios.adminttaudit.db;
...
import com.dataservicios.adminttaudit.model.Departament;
import com.dataservicios.adminttaudit.model.District;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	private Dao<TableAffected, Integer> TableAffectedDao = null;
	...
	public void onCreate(SQLiteDatabase db,ConnectionSource connectionSource) {
		try {
			...
			TableUtils.createTable(connectionSource, TableAffected.class);
	...
	public void onUpgrade(SQLiteDatabase db,ConnectionSource connectionSource, int oldVersion, int newVersion) {
		try {
            ...
            TableUtils.dropTable(connectionSource, TableAffected.class,true);
    ...
    public Dao<TableAffected, Integer> getTableAffectedDao() {
        if (null == TableAffectedDao) {
            try {
                TableAffectedDao = getDao(TableAffected.class);
            }catch (java.sql.SQLException e) {
                e.printStackTrace();
            }
        }
        return TableAffectedDao;
    }
